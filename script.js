...
video_players.forEach(video_player => {
  ...
  <div class="settings">
    ...
    <div class="playback" data-label="speed" hidden>
      ...
      <ul>
        ...
        <li data-speed="1.25" class="active">1.25</li>

        <li data-speed="1">ปกติ</li>
    ...
    <div data-label="quality" hidden>
      <span>
        ...
        <span>คุณภาพการเล่นวิดีโอ </span>
      </span>
      <ul>
        <li data-quality="auto" class="active">อัตโนมัติ</li>
      </ul>
    </div>
  </div>
  <div class="captions">
    <div class="caption">
      <span>เลือกคำบรรยาย</span>
      <ul>
  ...
  if (tracks.length != 0) {
    caption_labels.insertAdjacentHTML(
      "afterbegin",
      `<li data-track="OFF" class="active">ปิดคำบรรยาย</li>`
    );
  ...
  fast_rewind.addEventListener("click", skipB)
  function skipB() {
    mainVideo.currentTime -= 10;
  }

  // fast_forward video function
  fast_forward.addEventListener("click", skipF)
  function skipF() {
    mainVideo.currentTime += 10;
  }
  ...
  auto_play.addEventListener("click", () => {
    ...
    if (auto_play.classList.contains("active")) {
      auto_play.title = "การเล่นอัตโนมัติเปิดอยู่";
    } else {
      auto_play.title = "การเล่นอัตโนมัติปิดอยู่";
    }
  });
  ...
  mainVideo.addEventListener("ended", () => {
    if (auto_play.classList.contains("active")) {
      ...
      play_pause.title = "เล่นซ้ำ";
    }
  });

  // Picture in picture
  picture_in_picutre.addEventListener("click", toggleMiniPlayerMode)
  ...
  fullscreen.addEventListener("click", toggleFullScreenMode)
